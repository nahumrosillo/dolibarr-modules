...
/**
 * \file    test/phpunit/NahumThemeFunctionalTest.php
 * \ingroup nahumtheme
...
/**
 * Class NahumThemeFunctionalTest
 *
 ...
 *
 * @package Testnahumtheme
 */
class NahumThemeFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modNahumTheme')->click();
		} else {
			// Disable the module
			$this->byHref('modNahumTheme')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/nahumtheme/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('nahumtheme/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/nahumtheme/admin/about.php');
		$this->authenticate();
		return $this->assertContains('nahumtheme/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('nahumthemewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modNahumTheme_NahumThemeTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modNahumTheme_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
